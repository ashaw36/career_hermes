...
| 编号 | 决策 | 选择 | 不可逆理由 |
|------|------|------|-----------|
| **D1** | 产品形态 | B. 桌面应用（PySide6 GUI）| 个人自用工具，数据本地化优先，无需服务端部署成本 |
...
- **描述:** 提供多套简历模板供用户选择。
- **验收标准:**
  - AC-040: 提供≥3套模板（技术简洁 / 产品故事 / 综合型）
  - AC-041: 模板可切换，切换后简历内容自动重新渲染

#### FR-P1-07 技能图谱基础
- **描述:** 建立预置技能节点库，支持层级关系和别名。
- **验收标准:**
  - AC-042: 预置≥50 个常见技能节点
  - AC-043: 支持用户自定义添加技能
